...
const primaryButtonClass = 'bg-[#4a2518] text-[#fdf7ef] hover:bg-[#3a1b11]';
            ...
            <main id={SITE_MAIN_ID} tabIndex={-1} className={cn('mx-auto max-w-6xl px-3 pb-14 pt-2 sm:px-4 sm:pb-16 sm:pt-3', SITE_MAIN_FOCUS_CLASS)}>
                <header className="mb-8 rounded-2xl border border-[#b89572] bg-gradient-to-r from-[#3d2518] via-[#5c3820] to-[#3d2518] px-5 py-8 text-[#fdf7ef] shadow-lg sm:rounded-3xl sm:px-10 sm:py-10">
                    ...
                    <p className="mt-3 max-w-2xl text-xs leading-relaxed text-[#fdf7ef]/90 sm:text-sm">
                        Partner with Sweet Shop USA to offer handcrafted chocolates, clusters, and toffees to your customers. Tell us about your business—our team reviews applications during business hours.
                    </p>
                </header>
                ...
                <div className="grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
                    <article className="rounded-2xl border border-[#b89572] bg-[#f6ebdd] p-6 sm:p-7">
                        ...
                        <ol className="mt-4 list-decimal space-y-3 pl-5 text-xs leading-relaxed text-[#5c4032] marker:text-[#8a7264]">
                            <li>Contact wholesale support with your business details and what you&apos;d like to carry.</li>
                    ...
                    <article className="flex flex-col justify-between rounded-2xl border border-[#b89572] bg-[#fdf7ef] p-6 sm:p-7">
                        <div>
                            <h2 className="text-[11px] font-semibold uppercase tracking-[0.3em] text-[#5c4032]">Start your application</h2>
                            <p className="mt-3 text-xs leading-relaxed text-[#5c4032]">
                                Call wholesale customer service to speak with a representative and begin the approval process.
                            </p>
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <Link href="/contact" className={cn(baseButtonClass, primaryButtonClass, 'text-[11px] text-center')}>
                                Contact us
                            </Link>
