...
export function MenuItemsSortableList({ menu, items, categoryNames, pageNames, categoryStats, pageStats }: MenuItemsSortableListProps) {
    ...
    return (
        <div className="flex h-full min-h-0 flex-col gap-2 overflow-hidden">
            <p className="shrink-0 px-1 text-xs text-[#6e4a34]">
            ...
            {error ? (
                <p className="shrink-0 rounded-md border border-red-300 bg-red-50 px-3 py-2 text-xs text-red-800">{error}</p>
            ) : null}

            <div className={cn('min-h-0 flex-1 overflow-auto rounded-md border border-[#c49a78] bg-[#f8eddf]', saving && 'opacity-70')}>
